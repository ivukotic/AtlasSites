...
<head>
	...
	<title>ATLAS Event Picking Service</title>
    ...
    $(function() {
        ...
        $( "#dialog-confirm" ).dialog({
            ...
            buttons: {
                "Submit": function() { 
                    $( this ).dialog( "close" );
                    handleRequest(1);
                    // alert('Your SkimSlim request have been submitted. You may
					// follow progress at "View Status" tab');
                },
        ...
        $( "#dialog-jobinfo" ).dialog({
        	...
        	open: function(event, ui){
                ...
                // $(this).html("<p>Lorem ipsum dolor sit amet, consectetur
				// adipisicing elit.</p>");
                }
        });    
    });
	...
	$(document).ready(
	    ...
	    function() {		
            ...
            var oTable = $('#table_trees').dataTable({ 
            	"bFilter": false, 
            	"bInfo": false, 
            	"bPaginate": false,  
            ...
            $(document).on('click', '#statusDone tbody td img', function () {
            		...
            		if ( this.src.match('details_close') ) { 
                        ...
                        // console.log("open click");
            			this.src = "images/details_close.png";
            			sTableDone.fnOpen( nTr, fnFormatDetails(sTableDone, nTr), 'details' );/*
																								 * Open
																								 * this
																								 * row
																								 */
    ...
    <div class="maincolumn">
    	...
    	<div id="tabs">
            ...
            <div id="tabs-1" > <!-- style="overflow: auto; width: 100%" -->
                <br>
                <div class="subcolumn">
               		Please select the data format:
                    <select id="fileFormat">  
                        <option value="ESD">ESD</option>
                        <option value="AOD">AOD</option>
                        <option value="NTUP">NTUP</option>
                    </select>
                    <br>
                    <hr>
                    <br>
                	You may copy/paste your runnumber, event combinations here. Separate them by newline or comma.  </br>		
				    <textarea rows="16" cols="20" id="t_area">123456:123, 123457:234</textarea>
               ...
               <div class="subcolumnright">     
                   <p id="cbs_allTrees">
                   	<table cellpadding="0" cellspacing="0" border="0" class="display" id="table_trees" width="100%">
                   	<caption style="text-align:left;">Please select the datasets that you would like to search for the events.</caption>
                   	<thead> <tr> <th>select</th> <th>Dataset name</th> <th>Size</th> <th>Files</th></tr> </thead> 
                   	<tbody></tbody></table>
                   </p>
               ...
               <div style="clear:both;margin:auto;text-align:center;width:100%">.</div>
            </div>
            ...
            <div id="tabs-4">
                <p>EventPickingService is provided for all of the ATLAS data that can be access using FAX. Currently there is no limit on size of output data file or time to process it.  Service currently runs at University of Chicago at UC3 and UCT3, but will be expanded to use OSG resources.  </p>
